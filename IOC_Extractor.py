...
class IOCExtractor(tk.Tk):
    def __init__(self):
        ...
        self.review_output = scrolledtext.ScrolledText(self.review_frame, wrap=tk.WORD, height=10, bg='grey10', fg='snow', insertbackground='white')
        ...
        self.vt_results_output = scrolledtext.ScrolledText(self.vt_frame_tab, wrap=tk.WORD, height=10, bg='grey10', fg='snow', insertbackground='white')
...
6. Results will appear here.""")
        ...
        self.jsluice_results_output = scrolledtext.ScrolledText(self.jsluice_frame_tab, wrap=tk.WORD, height=10, bg='grey10', fg='snow', insertbackground='white')
...
Examples:
  ...
  find . -name '*.js' | jsluice secrets -c 5 --patterns=apikeys.json"""
        ...
        # Output Area
        self.shell_command_output = scrolledtext.ScrolledText(self.shell_command_frame, wrap=tk.WORD, height=10, bg='grey10', fg='light cyan', insertbackground='white')
